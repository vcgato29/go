...
func init() {
	...
	var (
		...
		// R10 is reserved by the assembler. R11 is reserved by some instructions.
	...
	var S390Xops = []opData{
		...
		{name: "MULHD", argLength: 2, reg: gp21tmp, asm: "MULHD", typ: "Int64", resultInArg0: true, clobberFlags: true},   // (arg0 * arg1) >> width
		{name: "MULHDU", argLength: 2, reg: gp21tmp, asm: "MULHDU", typ: "Int64", resultInArg0: true, clobberFlags: true}, // (arg0 * arg1) >> width
